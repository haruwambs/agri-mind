...
async function applyToJob(jobId) {
    ...
    // Get the applicant's email and name from the current user
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    document.querySelector('.main-content')?.addEventListener('click', async (e) => {
        ...
        if (target.closest('.contact-applicant-btn') || target.closest('.contact-poster-btn')) {
            ...
            if (!name || name === 'Unknown' || name === 'Unknown Applicant' || name === 'Applicant' || name === 'Employer' || name === 'undefined' || name.trim() === '') {
