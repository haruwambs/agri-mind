...
const CROP_DB = {
    ...
    bambara: { name: 'Bambara Nut (Zambia)', pests: {
            leaf_spot: { name: 'Bambara Leaf Spot', severity: 'high', lossPct: 25, dosage: 180, chemicals: ['Mancozeb','Copper'], organic: ['Copper spray','Crop rotation'], note: 'Common disease in Zambian bambara nut fields.' },
            rust: { name: 'Bambara Rust', severity: 'medium', lossPct: 20, dosage: 200, chemicals: ['Tebuconazole','Mancozeb'], organic: ['Sulfur spray','Resistant varieties'], note: 'Appears in warm humid conditions in Zambia.' },
            aphids: { name: 'Bambara Aphids', severity: 'medium', lossPct: 15, dosage: 150, chemicals: ['Acetamiprid','Dudu-Cyber'], organic: ['Neem Oil','Ladybugs'], note: 'Transmits viruses. Monitor early in the season.' },
            nematodes: { name: 'Root Knot Nematodes', severity: 'high', lossPct: 30, dosage: 0, chemicals: ['Fumigants (pre-plant)'], organic: ['Crop rotation','Organic matter'], note: 'Causes galls. Serious in sandy Zambian soils.' }
        }, yieldValue: 1200 
    },
    ...
    cowpea: { name: 'Cowpea (Zambia)', pests: {
            aphids: { name: 'Cowpea Aphids', severity: 'high', lossPct: 20, dosage: 150, chemicals: ['Acetamiprid','Dudu-Cyber'], organic: ['Neem Oil','Ladybugs'], note: 'Transmits viruses. Major pest in Zambian cowpea.' },
            pod_borer: { name: 'Cowpea Pod Borer', severity: 'critical', lossPct: 35, dosage: 220, chemicals: ['Cypermethrin','Dudu-Cyber'], organic: ['Bt spray','Neem Oil'], note: 'Most destructive pest of cowpea in Zambia.' },
            thrips: { name: 'Cowpea Thrips', severity: 'medium', lossPct: 15, dosage: 160, chemicals: ['Spinosad','Acetamiprid'], organic: ['Neem Oil','Sticky traps'], note: 'Cause flower abortion. Monitor during flowering stage.' },
            leaf_spot: { name: 'Cowpea Leaf Spot', severity: 'medium', lossPct: 15, dosage: 180, chemicals: ['Mancozeb','Copper'], organic: ['Copper spray','Crop rotation'], note: 'Dark spots on leaves. Common in humid conditions.' }
        }, yieldValue: 1600 
    },
    pigeon_pea: { name: 'Pigeon Pea (Zambia)', pests: {
            pod_borer: { name: 'Pod Borer', severity: 'critical', lossPct: 35, dosage: 220, chemicals: ['Cypermethrin','Dudu-Cyber'], organic: ['Bt spray','Neem Oil'], note: 'Major pest of pigeon pea in Zambia.' },
            aphids: { name: 'Pigeon Pea Aphids', severity: 'medium', lossPct: 15, dosage: 150, chemicals: ['Acetamiprid','Dudu-Cyber'], organic: ['Neem Oil','Ladybugs'], note: 'Transmit viruses. Monitor during flowering.' },
    ...
    irish_potato: { name: 'Irish Potato (Zambia)', pests: {
            late_blight: { name: 'Late Blight', severity: 'critical', lossPct: 35, dosage: 300, chemicals: ['Mancozeb','Metalaxyl','Rocket'], organic: ['Copper spray','Bordeaux mixture'], note: 'Devastating disease. Use resistant varieties where possible.' },
            early_blight: { name: 'Early Blight', severity: 'high', lossPct: 20, dosage: 250, chemicals: ['Chlorothalonil','Azoxystrobin'], organic: ['Copper spray','Crop rotation'], note: 'Causes dark concentric rings on older leaves.' },
            potato_aphids: { name: 'Potato Aphids', severity: 'medium', lossPct: 10, dosage: 130, chemicals: ['Acetamiprid','Dudu-Cyber'], organic: ['Neem Oil','Ladybugs'], note: 'Transmits potato leaf roll virus. Monitor carefully.' },
            potato_tuber_moth: { name: 'Potato Tuber Moth', severity: 'high', lossPct: 25, dosage: 180, chemicals: ['Bt spray','Fenitrothion'], organic: ['Bt spray','Covering soil','Pheromone traps'], note: 'Attack leaves and tubers. Keep soil covered.' }
        }, yieldValue: 3500 
    },
    yam: { name: 'Yam (Zambia)', pests: {
            yam_mosaic: { name: 'Yam Mosaic Virus', severity: 'high', lossPct: 30, dosage: 0, chemicals: ['No chemical treatment'], organic: ['Virus-free setts','Sanitation'], note: 'Transmitted by aphids. Use disease-free planting material.' },
            yam_nematodes: { name: 'Yam Nematodes', severity: 'high', lossPct: 25, dosage: 0, chemicals: ['Soil fumigation'], organic: ['Crop rotation','Organic matter'], note: 'Cause dry rot. Common in continuous yam cultivation.' },
            yam_beetles: { name: 'Yam Beetles', severity: 'medium', lossPct: 15, dosage: 160, chemicals: ['Acetamiprid','Dudu-Cyber'], organic: ['Hand picking','Neem Oil'], note: 'Feed on leaves. Active during rainy season.' },
            anthracnose: { name: 'Yam Anthracnose', severity: 'high', lossPct: 20, dosage: 200, chemicals: ['Mancozeb','Copper'], organic: ['Copper spray','Resistant varieties'], note: 'Dark lesions on stems and leaves. Favored by humid conditions.' }
        }, yieldValue: 2800 
    },
    carrot: { name: 'Carrot (Zambia)', pests: {
            leaf_blight: { name: 'Carrot Leaf Blight', severity: 'high', lossPct: 25, dosage: 180, chemicals: ['Mancozeb','Copper'], organic: ['Copper spray','Crop rotation'], note: 'Causes browning of leaves. Common in humid weather.' },
            root_knot_nematodes: { name: 'Root Knot Nematodes', severity: 'high', lossPct: 30, dosage: 0, chemicals: ['Soil fumigation'], organic: ['Crop rotation','Solarization'], note: 'Causes galls on roots. Serious in sandy soils.' },
    ...
    tobacco: { name: 'Tobacco (Zambia)', pests: {
            mosaic_virus: { name: 'Tobacco Mosaic Virus', severity: 'critical', lossPct: 40, dosage: 0, chemicals: ['No chemical treatment'], organic: ['Sanitation','Resistant varieties'], note: 'Highly infectious. Major concern for Zambian tobacco farmers.' },
            aphids: { name: 'Tobacco Aphids', severity: 'high', lossPct: 20, dosage: 200, chemicals: ['Acetamiprid','Dudu-Cyber'], organic: ['Neem Oil','Ladybugs'], note: 'Transmit viruses. Monitor throughout growing season.' },
            hornworm: { name: 'Hornworm', severity: 'high', lossPct: 25, dosage: 220, chemicals: ['Cypermethrin','Dudu-Cyber'], organic: ['Bt spray','Hand picking'], note: 'Large caterpillars. Major pest in Zambian tobacco.' },
            blue_mold: { name: 'Blue Mold', severity: 'high', lossPct: 30, dosage: 240, chemicals: ['Mancozeb','Metalaxyl'], organic: ['Copper spray','Good air circulation'], note: 'Favored by humid Zambian conditions. Monitor in seedbeds.' }
        }, yieldValue: 2500 
    },
    sunflower: { name: 'Sunflower (Zambia)', pests: {
            sunflower_moth: { name: 'Sunflower Moth', severity: 'critical', lossPct: 35, dosage: 240, chemicals: ['Cypermethrin','Dudu-Cyber'], organic: ['Biological control','Pheromone traps'], note: 'Larvae feed on seeds. Major pest in Zambian sunflower fields.' },
            head_rot: { name: 'Head Rot', severity: 'high', lossPct: 30, dosage: 220, chemicals: ['Mancozeb','Copper'], organic: ['Crop rotation','Good drainage'], note: 'Causes heads to rot. Favored by humid Zambian conditions.' },
            downy_mildew: { name: 'Downy Mildew', severity: 'high', lossPct: 25, dosage: 200, chemicals: ['Metalaxyl','Mancozeb'], organic: ['Resistant varieties','Good drainage'], note: 'White mold on leaves. Prefers cool, wet Zambian weather.' },
            aphids: { name: 'Sunflower Aphids', severity: 'medium', lossPct: 15, dosage: 160, chemicals: ['Acetamiprid','Dudu-Cyber'], organic: ['Neem Oil','Ladybugs'], note: 'Colonize heads and young leaves. Monitor during flowering.' }
        }, yieldValue: 1600 
    },
    sugarcane: { name: 'Sugarcane (Zambia)', pests: {
            stem_borer: { name: 'Sugarcane Stem Borer', severity: 'critical', lossPct: 30, dosage: 220, chemicals: ['Dudu-Cyber','Chlorpyrifos'], organic: ['Neem Oil','Biological control'], note: 'Major pest in Zambian sugarcane. Bores into stems.' },
            smut: { name: 'Sugarcane Smut', severity: 'high', lossPct: 25, dosage: 0, chemicals: ['Fungicide treatment of setts'], organic: ['Resistant varieties','Sanitation'], note: 'Black whip-like growth. Use disease-free setts.' },
            yellow_leaf_virus: { name: 'Sugarcane Yellow Leaf Virus', severity: 'high', lossPct: 20, dosage: 0, chemicals: ['No chemical treatment'], organic: ['Resistant varieties','Aphid control'], note: 'Causes yellowing. Transmitted by aphids.' },
            whitefly: { name: 'Sugarcane Whitefly', severity: 'medium', lossPct: 15, dosage: 180, chemicals: ['Imidacloprid','Acetamiprid'], organic: ['Neem Oil','Biological control'], note: 'Causes sooty mold. Monitor during dry season.' }
        }, yieldValue: 4000 
    },
    tea: { name: 'Tea (Zambia)', pests: {
            blister_blight: { name: 'Blister Blight', severity: 'high', lossPct: 25, dosage: 200, chemicals: ['Copper spray','Mancozeb'], organic: ['Copper spray','Pruning'], note: 'Causes blisters on leaves. Favored by humid weather.' },
            aphids: { name: 'Tea Aphids', severity: 'medium', lossPct: 12, dosage: 140, chemicals: ['Acetamiprid','Dudu-Cyber'], organic: ['Neem Oil','Ladybugs'], note: 'Attack young shoots. Monitor during flush growth.' },
            mites: { name: 'Red Spider Mites', severity: 'medium', lossPct: 15, dosage: 160, chemicals: ['Abamectin','Dicofol'], organic: ['Neem Oil','Sulfur spray'], note: 'Cause bronzing of leaves. Active in dry weather.' }
        }, yieldValue: 3000 
    },
    coffee: { name: 'Coffee (Zambia)', pests: {
            coffee_berry_borer: { name: 'Coffee Berry Borer', severity: 'critical', lossPct: 35, dosage: 240, chemicals: ['Cypermethrin','Imidacloprid'], organic: ['Biological control','Traps'], note: 'Most destructive coffee pest in Zambia.' },
            coffee_leaf_rust: { name: 'Coffee Leaf Rust', severity: 'critical', lossPct: 30, dosage: 220, chemicals: ['Copper spray','Tebuconazole'], organic: ['Copper spray','Resistant varieties'], note: 'Orange powdery spores. Major disease in Zambian coffee.' },
    ...
    lettuce: { name: 'Lettuce (Zambia)', pests: {
            downy_mildew: { name: 'Downy Mildew', severity: 'high', lossPct: 20, dosage: 180, chemicals: ['Metalaxyl','Mancozeb'], organic: ['Copper spray','Good air circulation'], note: 'Yellow patches on leaves. Favored by wet weather.' },
            aphids: { name: 'Lettuce Aphids', severity: 'medium', lossPct: 12, dosage: 130, chemicals: ['Acetamiprid','Dudu-Cyber'], organic: ['Neem Oil','Ladybugs'], note: 'Cause curling of leaves. Monitor regularly.' },
            root_rot: { name: 'Root Rot', severity: 'high', lossPct: 25, dosage: 0, chemicals: ['Soil fumigation'], organic: ['Good drainage','Crop rotation'], note: 'Causes wilting and death. Avoid waterlogged soils.' }
        }, yieldValue: 2500 
    },
    spinach: { name: 'Spinach (Zambia)', pests: {
            downy_mildew: { name: 'Downy Mildew', severity: 'high', lossPct: 20, dosage: 180, chemicals: ['Metalaxyl','Mancozeb'], organic: ['Copper spray','Good air circulation'], note: 'Purple-gray mold on leaves. Favored by humid weather.' },
            aphids: { name: 'Spinach Aphids', severity: 'medium', lossPct: 12, dosage: 130, chemicals: ['Acetamiprid','Dudu-Cyber'], organic: ['Neem Oil','Ladybugs'], note: 'Transmit viruses. Monitor during early growth.' },
    ...
    papaya: { name: 'Papaya (Zambia)', pests: {
            papaya_ringspot: { name: 'Papaya Ringspot Virus', severity: 'critical', lossPct: 50, dosage: 0, chemicals: ['No chemical treatment'], organic: ['Resistant varieties','Aphid control'], note: 'Devastating virus. Use resistant varieties.' },
            fruit_fly: { name: 'Papaya Fruit Fly', severity: 'high', lossPct: 30, dosage: 200, chemicals: ['Malathion','Protein bait'], organic: ['Fruit bagging','Pheromone traps'], note: 'Larvae feed inside fruit. Major pest in Zambia.' },
            powdery_mildew: { name: 'Powdery Mildew', severity: 'medium', lossPct: 15, dosage: 180, chemicals: ['Sulfur','Tebuconazole'], organic: ['Sulfur spray','Neem Oil'], note: 'White powder on leaves. Favored by dry weather.' },
            mites: { name: 'Papaya Mites', severity: 'medium', lossPct: 12, dosage: 160, chemicals: ['Abamectin','Dicofol'], organic: ['Neem Oil','Sulfur spray'], note: 'Cause leaf bronzing. Monitor during dry season.' }
        }, yieldValue: 3800 
    },
    avocado: { name: 'Avocado (Zambia)', pests: {
            anthracnose: { name: 'Avocado Anthracnose', severity: 'high', lossPct: 25, dosage: 200, chemicals: ['Mancozeb','Copper'], organic: ['Copper spray','Pruning'], note: 'Dark spots on fruit. Major post-harvest problem.' },
            root_rot: { name: 'Avocado Root Rot', severity: 'critical', lossPct: 40, dosage: 0, chemicals: ['Fosetyl-Al','Metalaxyl'], organic: ['Good drainage','Resistant rootstocks'], note: 'Causes wilting and death. Avoid waterlogged soils.' },
            thrips: { name: 'Avocado Thrips', severity: 'medium', lossPct: 12, dosage: 150, chemicals: ['Spinosad','Acetamiprid'], organic: ['Neem Oil','Beneficial insects'], note: 'Scarring on fruit. Monitor during flowering.' }
        }, yieldValue: 3500 
    },
    ...
    garlic: { name: 'Garlic (Zambia)', pests: {
            white_rot: { name: 'White Rot', severity: 'critical', lossPct: 40, dosage: 0, chemicals: ['Fungicide dip for cloves'], organic: ['Crop rotation (5-7 years)','Compost management'], note: 'White fungal growth. Causes premature yellowing.' },
            thrips: { name: 'Garlic Thrips', severity: 'high', lossPct: 20, dosage: 160, chemicals: ['Spinosad','Acetamiprid'], organic: ['Neem Oil','Sticky traps'], note: 'Silver-white streaks on leaves. Monitor from early stage.' },
            downy_mildew: { name: 'Downy Mildew', severity: 'high', lossPct: 20, dosage: 180, chemicals: ['Metalaxyl','Mancozeb'], organic: ['Copper spray','Good air circulation'], note: 'Purple-gray mold on leaves. Favored by wet weather.' }
        }, yieldValue: 2500 
    }
};
